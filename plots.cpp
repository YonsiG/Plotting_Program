...
/*******Switches********/
  ...
  char filename1[100]="../Ceres_looping/signal_selected.root";
  char filename2[100]="../Ceres_looping/Z+Jet_selected.root"; //if you only want to draw one plot, use filename1 only

  char plotname1[100]="fatjetMass_lead";
  char plotname2[100]="fatjetMass_lead"; //if you only want to draw one plot, use plotname1 only

  char saveFileName[100]="fatjetMass_lead.pdf";

  char Xtitle[100]="fatjetMass(GeV)";
  char Ytitle[100]="entries";

  char legend1[100]="signal";
  char legend2[100]="Z+Jet";
