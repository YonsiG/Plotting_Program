...
def main():
    ...
    signal_sample1 =  ROOT.TFile('./SSHHW_1_scaled.root')
    signal_sample2 =  ROOT.TFile('./OSWWH_1_scaled.root')
    signal_sample3 =  ROOT.TFile('./WZH_1_scaled.root')
    signal_sample4 =  ROOT.TFile('./ZZH_1_scaled.root')

    signal_sample12 =  ROOT.TFile('./SSHHW_2_scaled.root')
    signal_sample22 =  ROOT.TFile('./OSWWH_2_scaled.root')
    signal_sample32 =  ROOT.TFile('./WZH_2_scaled.root')
    signal_sample42 =  ROOT.TFile('./ZZH_2_scaled.root')

    signal_sample13 =  ROOT.TFile('./SSHHW_3_scaled.root')
    signal_sample23 =  ROOT.TFile('./OSWWH_3_scaled.root')
    signal_sample33 =  ROOT.TFile('./WZH_3_scaled.root')
    signal_sample43 =  ROOT.TFile('./ZZH_3_scaled.root')
...
#    print("%-25s%-15s%-15s%-15s%-15s%-15s"%('Cut','llhzz','ZH','2f','4f','S/sqrt(S+B)'))
    ...
    fout_script.write('%-30s&%-10s&%-10s&%-10s&%-10s%-5s\n'%('Cut','SSWWH','OSWWH','WZH','ZZH',r'\\'))
#    print('%-25s%-15s%-15s%-15s%-15s%-15s'%('Cut','llhzz','ZH','2f','4f','S/sqrt(S+B)'))
    ...
    fout_script.write('%-30s&%-10s&%-10s&%-10s&%-10s%-5s\n'%('VBF cut1                   ',round(signal17,3),round(signal27,3),round(signal37,3),round(signal47,3),r'\\'))
    fout_script.write('%-30s&%-10s&%-10s&%-10s&%-10s%-5s\n'%('VBF cut2                   ',round(signal18,3),round(signal28,3),round(signal38,3),round(signal48,3),r'\\'))
    fout_script.write('%-30s&%-10s&%-10s&%-10s&%-10s%-5s\n'%('VBF cut3                   ',round(signal19,3),round(signal29,3),round(signal39,3),round(signal49,3),r'\\'))
